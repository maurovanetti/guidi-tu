...
class BattleshipBomb extends BattleshipItem {
  BattleshipBomb(Vector2 position, {required super.board, super.player})
      : super('battleship/bomb.png', position);
  ...
  static BattleshipBomb createOn(
    ...
    return BattleshipBomb(newCell.center, board: newBoard, player: player);
  }
}
